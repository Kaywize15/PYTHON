...
Loading the Data into Python using Windows+R command (The Data format is a csv file)
...
Using the command (Crash.columns) to display all the columns in the data including the hidden ones
(52843 rows × 23 columns)



# SOLUTIONS TO TASK GIVEN
...
# PLOTTING THE DATA USING CHART
Step(i)

Using subplots function to plot a 2rows by 3columns chart with a figure size of 14 by 8.
